...
<head>
    <title>DeinPlugin • Chatlog Löschen</title>
    <meta charset="utf-8">
...
<nav class="navbar navbar-default">
    ...
    <div id="navbar" class="collapse navbar-collapse">
        <ul class="nav navbar-nav">
            ...
            <li class="active"><a href="#">Chatlog Liste</a></li>
...
<section id="breadcrumb">
    <div class="col-md-14">
        <ol class="breadcrumb">
            <a><span class="glyphicon glyphicon-list-alt" aria-hidden="true"></span> / Dashboard / Chatlogs</a>
        </ol>
    </div>
</section>
        ...
        <div class="row">
            ...
            <div class="col-md-9">
                <div class="panel panel-default">
                    <a class="list-group-item active"><span class="	glyphicon glyphicon-tag" aria-hidden="true"></span> Chatlogs (<?php echo(getChatlogID()); ?>)</a>
...
<div class="footer-section" style="bottom: 0; font-size: 12px;">
    <div class="container">
        <p>&copy; 2017, DeinPlugin Chatlog - by EJDAR and WeLoveSpigotPlugins</p>
    </div>
</div>
