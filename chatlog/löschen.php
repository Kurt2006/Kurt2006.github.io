...
<nav class="navbar navbar-default">
    ...
    <div id="navbar" class="collapse navbar-collapse">
        <ul class="nav navbar-nav">
            ...
            <li class="active"><a href="löschen.php">Chatlog Löschen</a></li>
        </ul>
...
<section id="breadcrumb">
    <div class="col-md-14">
        <ol class="breadcrumb">
            <a><span class="glyphicon glyphicon-list-alt" aria-hidden="true"></span> / Dashboard / Löschen</a>
        </ol>
    </div>
</section>
        ...
        <div class="row">
            ...
            <div class="col-md-9">
                <div class="panel panel-default">
                    <a class="list-group-item active"><span class="	glyphicon glyphicon-tag" aria-hidden="true"></span> Chatlog Löschen</a>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <form action="#" method="post">
                                    ...
                                    <input type="text" name="Key" class="form-control" placeholder="Key Eingeben">
                                    <br>
                                    <p><input type="submit" name="löschen" value="Löschen" class="btn btn-success btn-block"><p>
                                </form>
